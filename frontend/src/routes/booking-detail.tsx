  ...
  return (
    <section>
      ...
      <div className="mt-8 grid gap-6 xl:grid-cols-2">
        <div className="rounded-2xl border border-slate-800 bg-slate-900 p-6"><h2 className="text-lg font-semibold">Event</h2><dl className="mt-5 grid gap-5 sm:grid-cols-2"><Detail label="Event date" value={item.event_date} /><Detail label="Event type snapshot" value={item.event_type_snapshot.name} /><Detail label="Venue" value={item.venue_name} /><div className="sm:col-span-2"><Detail label="Venue address" value={item.venue_address} /></div><Detail label="Contact person" value={item.contact_person} /><Detail label="Contact number" value={item.contact_number} /></dl></div>
